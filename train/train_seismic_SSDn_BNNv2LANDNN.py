...
if __name__ == '__main__':
    ...
    parser.add_argument("--config", type=str, default='../option/three_stage_SASS_bnnv2.json')
    ...
    opt['num_iters'] =30000
    opt['train_datasets'][0]['type'] = "SeisNpyTrainDataset_noisy"
    opt['validation_datasets'][0]['type'] = "SeisNpyValidationDataset"
    opt['train_datasets'][0]['batch_size'] = 2

    opt['networks'][0]['args']['blindspot1'] = 1
    opt['networks'][0]['args']['blindspot2'] = 9
    opt['networks'][1]['args']['receptive_feild'] = 3
    opt['std_width'] = 7
    opt['beta_lower_upper'] = [{"lower": 1, "upper": 5}]  # [0.3,0.5][0.05,0.2]


    opt['log_dir'] = 'logs/XJ/BNNv2_LAN_DN_1_9'
    opt['log_file']='logs/XJ/BNNv2_LAN_DN_1_9/log.out'

    opt['train_datasets'][0]['args']['path']= '/home/shendi_mcj/datasets/seismic/fielddata/train/prep/SEGY_s256_o128_npy'
    opt['validation_datasets'][0]['args']['path'] = '/home/shendi_mcj/datasets/seismic/fielddata/train/prep/SEGY_s256_o128_npy'

    # opt['train_datasets'][0]['args']['path'] = '/home/shendi_mcj/datasets/seismic/PankeData/PK_s256_o128' #PK_test_s256_o128
    # opt['train_datasets'][0]['args']['path'] = '/home/shendi_mcj/datasets/seismic/test/PK_test_s256_o128'  # PK_test_s256_o128
