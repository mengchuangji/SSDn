...
if __name__ == '__main__':
    ...
    opt['num_iters'] =16000
    opt['std_width'] = 7
    opt['beta_lower_upper'] = [{"lower": 0.05, "upper": 0.2}]  # [0.3,0.5][0.05,0.2]
    opt['networks'][1]['args']['receptive_feild'] = 3
    opt['resume_from'] = '../train/logs/XJ/N2S_LAN_DN_bt_bst/model_iter_00002000.pth'


    opt['log_dir'] = 'logs/XJ/N2S_LAN_DN_bt_1'
    opt['log_file']='logs/XJ/N2S_LAN_DN_bt_1/log.out'
    ...
    # opt['train_datasets'][0]['args']['path'] = 'D:\datasets\seismic\panke\PK_test_s256_o128' #PK_s256_o128
    # opt['validation_datasets'][0]['args']['path'] = 'D:\datasets\seismic\panke\PK_test_s256_o128'

    # opt['train_datasets'][0]['args']['path'] = 'D:\datasets\seismic\XJ\SEGY_s256_o128' #PK_s256_o128
